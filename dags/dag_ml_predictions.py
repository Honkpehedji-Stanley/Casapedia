...
with DAG(
    ...
    catchup=False,
    tags=['casapedia', 'ml', 'spark', 'prediction', 'minio'],
) as dag:
    ...
    ml_predictions_spark = SparkSubmitOperator(
        ...
        verbose=True,
        env_vars={
            'CASAPEDIA_ML_SAMPLE_FRACTION': '0.001',
            'CASAPEDIA_ML_MAX_TRAINING_ROWS': '10000',
            'CASAPEDIA_ML_MAX_ITER': '10',
            'CASAPEDIA_ML_SHUFFLE_PARTITIONS': '16',
            'CASAPEDIA_ML_DEFAULT_PARALLELISM': '16',
        },
        conf={
